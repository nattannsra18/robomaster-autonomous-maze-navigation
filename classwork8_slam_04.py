...
from classwork8.tof_only_v04 import run


def _v04_defaults(config: Classwork8Config) -> None:
    ...
    # test. Start V04 from neutral odometry scale and tune through the GUI.
    ...
    # V04 completion/export defaults for the closed classwork maze.
...
def main():
    ...
    parser.add_argument(
        "--no-gui",
        action="store_true",
        help="run terminal-only using V04 defaults",
    )
    parser.add_argument(
        "--no-vision",
        action="store_true",
    ...
    from classwork8.gui_v04 import run_with_gui
