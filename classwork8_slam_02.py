"""Standalone entry point for Classwork 8 SLAM exploration - version 02.
...
from classwork8.tof_only_v02 import run


def main():
    parser = argparse.ArgumentParser(description="Classwork 8 SLAM exploration v02")
    parser.add_argument(
        "--no-gui",
        action="store_true",
