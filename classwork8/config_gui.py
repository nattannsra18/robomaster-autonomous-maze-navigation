"""Pre-mission configuration GUI for Classwork 8 V03.
...
def configure_before_run(config) -> bool:
    ...
    root = tk.Tk()
    root.title("Classwork 8 V03 - Mission Configuration")
    ...
    ttk.Label(
        outer,
        text="Classwork 8 V03 - Mission Configuration",
    ...
    tabs = {}
    for name in ("Motion", "ToF / Safety", "Mapping", "Vision"):
    ...
    field_specs: Dict[str, List[Tuple[str, str, str, str]]] = {
        ...
        "Vision": [
            ("vision_enabled", "Enable camera processing", "bool", "Camera is optional; ToF remains authoritative"),
            ("vision_steering_enabled", "Allow camera steering", "bool", "Leave OFF until corridor detection is calibrated"),
            ("vision_resolution", "Camera resolution", "choice", "360p is recommended for low latency"),
            ("vision_min_confidence", "Vision min confidence", "float", "Required before correction can be proposed"),
            ("vision_kp_mps", "Vision correction Kp", "float", "Lateral camera correction gain"),
            ("vision_max_correction_mps", "Max vision correction (m/s)", "float", "Hard limit"),
        ],
    }
    ...
    def set_v03_defaults():
        defaults = {
            ...
            "vision_resolution": "360p",
            "vision_min_confidence": 0.70,
            "vision_kp_mps": 0.035,
            "vision_max_correction_mps": 0.025,
        }
