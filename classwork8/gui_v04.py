"""Realtime discovered-grid GUI for Classwork 8 V04.
...
class RealtimeMapGUI:
    ...
    def __init__(
        ...
        self.root = tk.Tk()
        self.root.title("Classwork 8 V04 - Frontier Exploration")
        ...
        ttk.Label(
            right,
            text="Classwork 8 V04",
            font=("Segoe UI", 16, "bold"),
        ).pack(anchor="w")
        ttk.Label(
            right,
            text="Frontier BFS + closed-maze auto completion",
            font=("Segoe UI", 10),
    ...
    def _export_map_png(self, snapshot: dict, target_path: Path) -> None:
        ...
        title = "Classwork 8 V04 - GUI Logical Map"
